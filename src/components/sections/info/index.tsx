    ...
    <Section className="flex flex-row items-center">
      <div className="relative z-20 max-w-7xl mx-auto">
        <div className="px-8">
          ...
          <p className="text-sm lg:text-base font-mono  max-w-2xl  my-8 mx-auto text-center font-normal text-neutral-300">
            ...
            for literally everything. We can even create this custom components
            on demand.
          </p>
        </div>
      </div>
      <div className="w-3/4 h-[60vh] px-1 md:px-8 flex items-center justify-center [perspective:800px] [transform-style:preserve-3d]">
        <div
          ...
          className="p-1 md:p-4 border rounded-3xl dark:bg-neutral-900 bg-neutral-900  border-[#FFDB89] shadow-lg shadow-[#FFDB89] dark:border-neutral-800 mx-auto w-3/4 h-1/2 md:h-3/4"
        >
          <Compare
